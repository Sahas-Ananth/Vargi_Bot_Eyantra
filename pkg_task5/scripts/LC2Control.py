...
from pkg_task5.msg import task5Action
from pkg_task5.msg import task5Goal
...
class Camera(object):
    ...
    For this to be possible a user defined action file is generated *task5Action*.
    """
    ...
    def send_goal(self, name, colour, package_pose):
        """
            ...
            the pose.
        """
        goal = task5Goal(package_name=name, colour=colour,
